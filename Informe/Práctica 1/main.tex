...
\begin {center}
 \begin{tabular} {|c|c|}
	...
	seno 1023 Hz, 0.3 V amp (@ mic 100/100) & 0.49 $ \frac{\mu V}{\sqrt{Hz}}$\\
        \hline
        SNR potencia (@ fs: 352800 Hz)  &  \\
        \hline
         seno 1023 Hz, 0.3 V amp (@ mic 10/100) & 9.5 db \\
	seno 1023 Hz, 0.3 V amp (@ mic 100/100) & 12.0 db \\
	\hline
        Crosstalk potencia (CH0 a CH1) (@ fs: 352800 Hz) & \\
	\hline
        seno 1023 Hz, 1.0 V amp (@ mic 70/100) & 10.5 db \\
        \hline
       Frecuencia (@ fs: 44100 Hz) & \\
        \hline
